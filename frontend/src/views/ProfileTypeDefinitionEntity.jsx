...
import { LoadingContext, UpdateRecentFileList } from "../components/contexts/LoadingContext";
...
function ProfileTypeDefinitionEntity() {
   ...
   //var pageMode = //state is not always present. If user types a url or we use an href link, state is null. location.state.viewMode;
   ...
   const prompt = usePrompt(
      "Unsaved changes will be lost. Ok to exit the page? To save, click Cancel then click Save.",
      loadingProps.bIsTypeEditUnsaved
   );
