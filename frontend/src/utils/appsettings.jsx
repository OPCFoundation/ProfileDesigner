...
export const AppSettings = {
   ...
   , MsalConfig: {
      auth: {
         clientId: import.meta.env.VITE_MSAL_CLIENT_ID, //Application (client) id in Azure of the registered application
         authority: import.meta.env.VITE_MSAL_AUTHORITY, //MSAL code will append client id, oauth path
      ...
      system: {
         ...
         loggerOptions: {
            ...
            loggerCallback: (level, message, containsPii) => {
               ...
               if (!import.meta.env.VITE_MSAL_ENABLE_LOGGER) return;
   ...
   , MsalScopes: [import.meta.env.VITE_MSAL_SCOPE]  //tied to scope defined in app registration / scope, set in Azure AAD
